 ...
 * @author mariher
 */
@WebServlet(name = "SaveRecipeServlet", urlPatterns = {"/save_recipe"})
public class SaveRecipeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BookDB.saveRecipe(client.getId(),recipeId);
        
        // Add experience to the user for saving a recipe in their book
